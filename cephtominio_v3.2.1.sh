#!/usr/local/bin/bash
# =================================================================================================
# cephtominio_v3.2.1.sh — репликация Ceph S3 ➜ MinIO S3 с rclone
...
#
# ИСПРАВЛЕНИЯ в версии 3.2.1:
# - ИСПРАВЛЕНО: Функция retry_rclone() - убран некорректный разделитель "--"
...
Примеры:
  # Тестовый запуск
  DRY_RUN=true $SCRIPT_NAME --parallel=2
  
  # Рабочий запуск с валидацией
  $SCRIPT_NAME --op=sync --validate=counts
