...
# v3.4.0 снизил 16->4 ради борьбы с rate-limit. v3.4.1 вернул до 8: реальная
# причина медленных прогонов оказалась в --fast-list (теперь выключен), а фаза
# сверки латентностно-ограничена — больше чекеров прямо её ускоряют. 8, а не 16,
# как компромисс с ограничением tpslimit.
: "${RCLONE_CHECKERS:=8}"
