#!/usr/bin/env bash
#
# rclone_04.2.1.sh - Исправленная версия (2.1)
# ====================================================
# 
# ОПИСАНИЕ:
...
# ВЕРСИЯ: 2.1 (Сентябрь 2025) - ИСПРАВЛЕНА ОШИБКА С LOCK_FD
...
# - ИСПРАВЛЕНА критическая ошибка с readonly переменной LOCK_FD
# - Современные методы работы с файловыми дескриптораами bash 4.1+
